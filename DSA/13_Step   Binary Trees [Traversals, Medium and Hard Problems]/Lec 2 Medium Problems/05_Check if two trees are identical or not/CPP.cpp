...
bool sameTree(TreeNode<int>*root1,TreeNode<int>*root2){
    if(!root1 or !root2)
        return root1==root2;
...
int main(){
    ...
    #endif
    TreeNode<int>*root1=NULL,*root2=NULL;
    root1=root1->CREATE_ITERATIVE();
    root2=root2->CREATE_ITERATIVE();
    cout<<"Identical tree or not : "<<sameTree(root1,root2)<<endl;
    return 0;
}