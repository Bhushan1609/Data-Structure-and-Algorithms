...
void yes(bool t = 1) { print(t ? "yes" : "no"); }
void no(bool t = 1) { yes(!t); }
void functionByPassValue(int a){
    a+=5;
    print("Value a in Value Function is : ", a);
    printn();
    return ;
}
void functionByPassReference(int &a){
    a+=5;
    print("Value a in Reference Function is : ", a);
    printn();
    return ;
}
void itachi_1609(){
    int a=10;
    print("Intial Value in parent Function is : ", a);
    printn();
    functionByPassValue(a);
    print("Intial Value in parent Function after Pass by Value Funcion is : ", a);
    printn();
    ...
    print("Intial Value in parent Function is : ", a);
    printn();
    functionByPassReference(a);
    print("Intial Value in parent Function after Pass by Reference Funcion is : ", a);
    printn();
